...
then
	...
	rm -rf ./buildroot/output/build/aesd-assignments-custom
	make -C buildroot BR2_EXTERNAL=${EXTERNAL_REL_BUILDROOT} AESD_ASSIGNMENTS_OVERRIDE_SRCDIR=/home/erik/coursera/assignment-1-statropy
